...
def run_config(configuration_and_data: List[Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        x_sim, rmse, r2, aic = sindy_helpers.evaluate_model(model, data, start_index, current_steps, ksteps, {"rtol": 1e-4,"atol": 1e-4}) # Perform a longer simulation for final metric calculation and evaluate the model
